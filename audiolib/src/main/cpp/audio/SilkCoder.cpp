...
void SilkCoder::SilkToPcmConvert(
        const char *silkPath,
        const char *pcmPath,
        bool debug,
        int fs_Hz,
    ...
    /* get arguments */
    bitInFileName = silkPath;
    speechOutFileName = pcmPath;
    API_Fs_Hz = fs_Hz;
    loss_prob = loss;
...
void SilkCoder::PcmToSilkConvert(
        const char *pcmPath,
        const char *silkPath,
        bool tencent,
        bool debug,
    ...
    /* get arguments */
    speechInFileName = pcmPath;
    bitOutFileName = silkPath;
    API_fs_Hz = fs_Hz;
    max_internal_fs_Hz = maxInternalSampleRate;
    packetSize_ms = packetSizeMs;
    packetLoss_perc = packetLossPercentage;
    INBandFEC_enabled = useInBandFEC;
    DTX_enabled = useDTX;
    complexity_mode = complexity;
    targetRate_bps = bitRate;
